    ...
    public class AuthorizeTests
    {
        ...
        public async Task signin_request_should_have_authorization_params(Type storeType)
        {
            ...
            var url = _mockPipeline.CreateAuthorizeUrl(
                ...
                {
                    new("display" , "popup"), // must use a valid value from the spec for display
                    new("ui_locales" , "ui_locale_value"),
                    new("custom_foo" , "foo_value")
                });
        ...
        public async Task locale_too_long_should_show_error_page()
        {
            ...
            var url = _mockPipeline.CreateAuthorizeUrl(
                ...
                state: "123_state",
                nonce: "123_nonce",
                extra: new Parameters( ){ new ("ui_locales", new string('x', 500)) });
            await _mockPipeline.BrowserClient.GetAsync(url);
        ...
        public async Task invalid_max_age_should_show_error_page()
        {
            ...
            var url = _mockPipeline.CreateAuthorizeUrl(
                ...
                state: "123_state",
                nonce: "123_nonce",
                extra: new Parameters(){ new ("max_age", "invalid") });
            await _mockPipeline.BrowserClient.GetAsync(url);
        ...
        public async Task negative_max_age_should_show_error_page()
        {
            ...
            var url = _mockPipeline.CreateAuthorizeUrl(
                ...
                state: "123_state",
                nonce: "123_nonce",
                extra: new Parameters{ new ("max_age", "-10") });
            await _mockPipeline.BrowserClient.GetAsync(url);
        ...
        public async Task ui_locales_should_be_passed_to_error_page()
        {
            ...
            var url = _mockPipeline.CreateAuthorizeUrl(
                ...
                nonce: "123_nonce",
                acrValues: new string('x', 500),
                extra: new Parameters() { new ("ui_locales", "fr-FR") });
            await _mockPipeline.BrowserClient.GetAsync(url);
        ...
        public async Task display_mode_should_be_passed_to_error_page()
        {
            ...
            var url = _mockPipeline.CreateAuthorizeUrl(
                ...
                nonce: "123_nonce",
                acrValues: new string('x', 500),
                extra: new Parameters { new ("display", "popup") });
        ...
        public async Task prompt_login_should_show_login_page()
        {
            ...
            var url = _mockPipeline.CreateAuthorizeUrl(
                ...
                state: "123_state",
                nonce: "123_nonce",
                extra:new Parameters{ new ("prompt", "login") }
            );
            var response = await _mockPipeline.BrowserClient.GetAsync(url);
